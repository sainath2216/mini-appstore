      ...
      <div className="app-container">
        <div className="container">
          ...
          <ul className="tab-container">
            {tabsList.map(tabItemDetails => (
              <TabItem
                key={tabItemDetails.tabId}
                tabItemDetails={tabItemDetails}
                selectedActiveTab={this.selectedActiveTab}
                isActive={activeTabId === tabItemDetails.tabId}
              />
            ))}
          </ul>
